...
export const USERCONTACT_EMAIL_TEMPLETE = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>{Vision RISE}</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right,rgba(186, 34, 39, 1),rgba(229, 47, 114, 1)); padding: 20px; text-align: center;">
    <h2 style="color: white; margin: 0;"> REACH OUT</h2>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,</p>
    <p>This is the message from well wisher:</p>
  ...
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
    <p>This is email is from a potential humaniterian, kindly reach out to them as soon as possible</p>
  </div>
</body>
</html>
`;

export const USERCONTACT_EMAIL_TEMPLETE_AUTO_REPLY = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right,rgb(12, 58, 14),rgb(9, 70, 12)); padding: 20px; text-align: center;">
    <h1 style="color: white; margin: 0;">VISION RISE </h1>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,{name}</p>
    <p>Thank you for contacting Vision Rise:</p>
    <div style="text-align: center; margin: 30px 0;">
    ...
    <h3>Facebook: Vision Rise</h3>
    <h3> X:  @Vision Rise</h3>
    <h3>Tiktok:  Vision Rise</h3>
